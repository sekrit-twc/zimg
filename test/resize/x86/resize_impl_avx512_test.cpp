               ...
               const zimg::PixelFormat &format, const char * const expected_sha1[3], double expected_snr)
{
	...
	std::unique_ptr<zimg::graph::ImageFilter> filter_avx512 = builder.set_cpu(zimg::CPUClass::X86_AVX512).create();
	...
	if (format.type != zimg::PixelType::HALF) {
		...
		ASSERT_FALSE(assert_different_dynamic_type(filter_c.get(), filter_avx512.get()));
               ...
               const zimg::PixelFormat &format, const char *expected_sha1, double expected_snr)
{
	...
	std::unique_ptr<graphengine::Filter> filter_avx512 = builder.set_cpu(zimg::CPUClass::X86_AVX512).create_ge();
	...
	// No half-precision implementation is available in C. Make sure to visually check results if they differ from hash.
	if (format.type != zimg::PixelType::HALF) {
		filter_c = builder.set_cpu(zimg::CPUClass::NONE).create_ge();
		ASSERT_FALSE(assert_different_dynamic_type(filter_c.get(), filter_avx512.get()));
...
TEST(ResizeImplAVX512Test, test_resize_h_u10)
{
...
TEST(ResizeImplAVX512Test, test_resize_h_u10_ge)
{
	const unsigned src_w = 640;
	const unsigned dst_w = 960;
	const unsigned h = 480;
...
TEST(ResizeImplAVX512Test, test_resize_h_u16)
{
	const unsigned src_w = 640;
	const unsigned dst_w = 960;
	const unsigned h = 480;
...
TEST(ResizeImplAVX512Test, test_resize_h_u16_ge)
{
	const unsigned src_w = 640;
	const unsigned dst_w = 960;
	const unsigned h = 480;
...
TEST(ResizeImplAVX512Test, test_resize_v_u10)
{
...
TEST(ResizeImplAVX512Test, test_resize_v_u10_ge)
{
	const unsigned w = 640;
	const unsigned src_h = 480;
	const unsigned dst_h = 720;
	...
	test_case_ge(zimg::resize::BilinearFilter{}, false, w, src_h, w, dst_h, format, expected_sha1[0], expected_snr);
	test_case_ge(zimg::resize::Spline16Filter{}, false, w, src_h, w, dst_h, format, expected_sha1[1], expected_snr);
	test_case_ge(zimg::resize::LanczosFilter{ 4 }, false, w, src_h, w, dst_h, format, expected_sha1[2], expected_snr);
	test_case_ge(zimg::resize::LanczosFilter{ 4 }, false, w, dst_h, w, src_h, format, expected_sha1[3], expected_snr);
}

TEST(ResizeImplAVX512Test, test_resize_v_u16)
{
	const unsigned w = 640;
	const unsigned src_h = 480;
	const unsigned dst_h = 720;
...
TEST(ResizeImplAVX512Test, test_resize_v_u16_ge)
{
	const unsigned w = 640;
	const unsigned src_h = 480;
	const unsigned dst_h = 720;
...
TEST(ResizeImplAVX512Test, test_resize_h_f16)
{
	const unsigned src_w = 640;
	const unsigned dst_w = 960;
	const unsigned h = 480;
...
TEST(ResizeImplAVX512Test, test_resize_h_f16_ge)
{
	const unsigned src_w = 640;
	const unsigned dst_w = 960;
	const unsigned h = 480;
	...
	test_case_ge(zimg::resize::BilinearFilter{}, true, src_w, h, dst_w, h, format, expected_sha1[0], NAN);
	test_case_ge(zimg::resize::Spline16Filter{}, true, src_w, h, dst_w, h, format, expected_sha1[1], NAN);
	test_case_ge(zimg::resize::LanczosFilter{ 4 }, true, src_w, h, dst_w, h, format, expected_sha1[2], NAN);
	test_case_ge(zimg::resize::LanczosFilter{ 4 }, true, dst_w, h, src_w, h, format, expected_sha1[3], NAN);
}

TEST(ResizeImplAVX512Test, test_resize_v_f16)
{
	const unsigned w = 640;
	const unsigned src_h = 480;
	const unsigned dst_h = 720;
...
TEST(ResizeImplAVX512Test, test_resize_v_f16_ge)
{
	const unsigned w = 640;
	const unsigned src_h = 480;
	const unsigned dst_h = 720;
	...
	test_case_ge(zimg::resize::BilinearFilter{}, false, w, src_h, w, dst_h, type, expected_sha1[0], NAN);
	test_case_ge(zimg::resize::Spline16Filter{}, false, w, src_h, w, dst_h, type, expected_sha1[1], NAN);
	test_case_ge(zimg::resize::LanczosFilter{ 4 }, false, w, src_h, w, dst_h, type, expected_sha1[2], NAN);
	test_case_ge(zimg::resize::LanczosFilter{ 4 }, false, w, dst_h, w, src_h, type, expected_sha1[3], NAN);
}

TEST(ResizeImplAVX512Test, test_resize_h_f32)
{
	const unsigned src_w = 640;
	const unsigned dst_w = 960;
	const unsigned h = 480;
...
TEST(ResizeImplAVX512Test, test_resize_h_f32_ge)
{
	const unsigned src_w = 640;
	const unsigned dst_w = 960;
	const unsigned h = 480;
...
TEST(ResizeImplAVX512Test, test_resize_v_f32)
{
	const unsigned w = 640;
	const unsigned src_h = 480;
	const unsigned dst_h = 720;
...
TEST(ResizeImplAVX512Test, test_resize_v_f32_ge)
{
	const unsigned w = 640;
	const unsigned src_h = 480;
	const unsigned dst_h = 720;
