               ...
               const zimg::PixelFormat &format, const char * const expected_sha1[3], double expected_snr)
{
	...
	FilterValidator validator{ filter_sse2.get(), src_w, src_h, format };
               ...
               const zimg::PixelFormat &format, const char *expected_sha1, double expected_snr)
{
	...
	auto filter_sse = builder.set_cpu(zimg::CPUClass::X86_SSE2).create_ge();

	ASSERT_FALSE(assert_different_dynamic_type(filter_c.get(), filter_sse.get()));

	graphengine::FilterValidation(filter_sse.get(), { src_w, src_h, zimg::pixel_size(format.type) })
		.set_input_pixel_format({ format.depth, zimg::pixel_is_float(format.type), false})
...
TEST(ResizeImplSSE2Test, test_resize_h_u10_ge)
{
	const unsigned src_w = 640;
	const unsigned dst_w = 960;
	const unsigned h = 480;
...
TEST(ResizeImplSSE2Test, test_resize_h_u16_ge)
{
	const unsigned src_w = 640;
	const unsigned dst_w = 960;
	const unsigned h = 480;
...
TEST(ResizeImplSSE2Test, test_resize_v_u10_ge)
{
	const unsigned w = 640;
	const unsigned src_h = 480;
	const unsigned dst_h = 720;
...
TEST(ResizeImplSSE2Test, test_resize_v_u16_ge)
{
	const unsigned w = 640;
	const unsigned src_h = 480;
	const unsigned dst_h = 720;
