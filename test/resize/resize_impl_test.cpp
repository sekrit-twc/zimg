...
void test_case(const zimg::PixelFormat &format, bool horizontal, double scale_factor, double shift, double subwidth_factor, const char * const *expected_sha1)
{
...
TEST(ResizeImplTest, test_horizontal_padding_bits)
{
...
TEST(ResizeImplTest, test_vertical_padding_bits)
{
	zimg::PixelFormat format = zimg::PixelType::WORD;
	format.depth = 7;
