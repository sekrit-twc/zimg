...
void test_case_ge(const zimg::colorspace::ColorspaceDefinition &csp_in, const zimg::colorspace::ColorspaceDefinition &csp_out, const char * const expected_sha1[3])
{
	const unsigned w = 640;
	const unsigned h = 480;
...
TEST(ColorspaceConversionTest, test_nop_ge)
{
	using namespace zimg::colorspace;
...
TEST(ColorspaceConversionTest, test_matrix_only_ge)
{
	using namespace zimg::colorspace;
	...
	{
		SCOPED_TRACE("rgb->709");
		test_case_ge({ MatrixCoefficients::RGB, TransferCharacteristics::UNSPECIFIED, ColorPrimaries::UNSPECIFIED },
				  { MatrixCoefficients::REC_709, TransferCharacteristics::UNSPECIFIED, ColorPrimaries::UNSPECIFIED },
		          expected_sha1[0]);
	}
	{
		SCOPED_TRACE("rgb->709 (derived)");
		test_case_ge({ MatrixCoefficients::RGB, TransferCharacteristics::REC_709, ColorPrimaries::REC_709 },
				  { MatrixCoefficients::CHROMATICITY_DERIVED_NCL, TransferCharacteristics::REC_709, ColorPrimaries::REC_709 },
		          expected_sha1[0]);
	}
	{
		SCOPED_TRACE("709->rgb");
		test_case_ge({ MatrixCoefficients::REC_709, TransferCharacteristics::UNSPECIFIED, ColorPrimaries::UNSPECIFIED },
				  { MatrixCoefficients::RGB, TransferCharacteristics::UNSPECIFIED, ColorPrimaries::UNSPECIFIED },
		          expected_sha1[1]);
	}
	{
		SCOPED_TRACE("709->rgb (derived)");
		test_case_ge({ MatrixCoefficients::CHROMATICITY_DERIVED_NCL, TransferCharacteristics::REC_709, ColorPrimaries::REC_709 },
				  { MatrixCoefficients::RGB, TransferCharacteristics::REC_709, ColorPrimaries::REC_709 },
		          expected_sha1[1]);
	}
	{
		SCOPED_TRACE("601->709");
		test_case_ge({ MatrixCoefficients::REC_601, TransferCharacteristics::UNSPECIFIED, ColorPrimaries::UNSPECIFIED },
				  { MatrixCoefficients::REC_709, TransferCharacteristics::UNSPECIFIED, ColorPrimaries::UNSPECIFIED },
		          expected_sha1[2]);
	}
	{
		SCOPED_TRACE("smpte_c->rgb (derived)");
		test_case_ge({ MatrixCoefficients::CHROMATICITY_DERIVED_NCL, TransferCharacteristics::REC_709, ColorPrimaries::SMPTE_C },
				  { MatrixCoefficients::RGB, TransferCharacteristics::REC_709, ColorPrimaries::SMPTE_C },
		          expected_sha1[3]);
	}
	{
		SCOPED_TRACE("rgb->smpte_c (derived)");
		test_case_ge({ MatrixCoefficients::RGB, TransferCharacteristics::REC_709, ColorPrimaries::SMPTE_C },
				  { MatrixCoefficients::CHROMATICITY_DERIVED_NCL, TransferCharacteristics::REC_709, ColorPrimaries::SMPTE_C },
		          expected_sha1[4]);
	}
}
...
TEST(ColorspaceConversionTest, test_transfer_only_ge)
{
	using namespace zimg::colorspace;
	...
	{
		SCOPED_TRACE("gamma->linear");
		test_case_ge(csp_gamma, csp_linear, expected_sha1[0]);
	}
	{
		SCOPED_TRACE("st2084->linear");
		test_case_ge(csp_st2084, csp_linear, expected_sha1[1]);
	}
	{
		SCOPED_TRACE("linear->gamma");
		test_case_ge(csp_linear, csp_gamma, expected_sha1[2]);
	}
	{
		SCOPED_TRACE("linear->st2084");
		test_case_ge(csp_linear, csp_st2084, expected_sha1[3]);
	}
}
...
TEST(ColorspaceConversionTest, test_transfer_only_b67_ge)
{
	using namespace zimg::colorspace;
	...
	{
		SCOPED_TRACE("b67->linear");
		test_case_ge(csp_arib_b67, csp_linear, expected_sha1[0]);
	}
	{
		SCOPED_TRACE("b67->linear (2020)");
		test_case_ge(csp_arib_b67_2020, csp_linear_2020, expected_sha1[1]);
	}
	{
		SCOPED_TRACE("linear->arib_b67");
		test_case_ge(csp_linear, csp_arib_b67, expected_sha1[2]);
	}
	{
		SCOPED_TRACE("linear->arib_b67 (2020)");
		test_case_ge(csp_linear_2020, csp_arib_b67_2020, expected_sha1[3]);
	}
}
...
TEST(ColorspaceConversionTest, test_matrix_transfer_ge)
{
	using namespace zimg::colorspace;
	...
	test_case_ge({ MatrixCoefficients::REC_709, TransferCharacteristics::LINEAR, ColorPrimaries::UNSPECIFIED },
	          { MatrixCoefficients::REC_601, TransferCharacteristics::REC_709, ColorPrimaries::UNSPECIFIED },
	          expected_sha1);
}
...
TEST(ColorspaceConversionTest, test_matrix_transfer_primaries_ge)
{
	using namespace zimg::colorspace;
	...
	{
		SCOPED_TRACE("709->smpte_c");
		test_case_ge({ MatrixCoefficients::REC_709, TransferCharacteristics::REC_709, ColorPrimaries::REC_709 },
		          { MatrixCoefficients::REC_601, TransferCharacteristics::REC_709, ColorPrimaries::SMPTE_C },
		          expected_sha1[0]);
	}
	{
	...
	{
		SCOPED_TRACE("p3->p3d65");
		test_case_ge({ MatrixCoefficients::REC_709, TransferCharacteristics::REC_709, ColorPrimaries::DCI_P3 },
		          { MatrixCoefficients::REC_709, TransferCharacteristics::REC_709, ColorPrimaries::DCI_P3_D65 },
		          expected_sha1[3]);
	}
}
...
TEST(ColorspaceConversionTest, test_constant_luminance_ge)
{
	using namespace zimg::colorspace;
	...
	{
		SCOPED_TRACE("709cl->linear_rgb (derived)");
		test_case_ge({ MatrixCoefficients::CHROMATICITY_DERIVED_CL, TransferCharacteristics::REC_709, ColorPrimaries::REC_709 },
	              { MatrixCoefficients::RGB, TransferCharacteristics::LINEAR, ColorPrimaries::REC_709 },
	              expected_sha1[4]);
	}
	{
		SCOPED_TRACE("linear_rgb->709cl (derived)");
		test_case_ge({ MatrixCoefficients::RGB, TransferCharacteristics::LINEAR, ColorPrimaries::REC_709 },
	              { MatrixCoefficients::CHROMATICITY_DERIVED_CL, TransferCharacteristics::REC_709, ColorPrimaries::REC_709 },
		          expected_sha1[5]);
	}
}
...
TEST(ColorspaceConversionTest, test_rec2100_ictcp_ge)
{
	using namespace zimg::colorspace;
	...
	{
		SCOPED_TRACE("linear rgb->st2084 ictcp");
		test_case_ge({ MatrixCoefficients::RGB, TransferCharacteristics::LINEAR, ColorPrimaries::REC_2020 },
		          { MatrixCoefficients::REC_2100_ICTCP, TransferCharacteristics::ST_2084, ColorPrimaries::REC_2020 },
	          expected_sha1[0]);
	}
	{
	...
	{
		SCOPED_TRACE("st2084 ictcp->linear rgb");
		test_case_ge({ MatrixCoefficients::REC_2100_ICTCP, TransferCharacteristics::ST_2084, ColorPrimaries::REC_2020 },
		          { MatrixCoefficients::RGB, TransferCharacteristics::LINEAR, ColorPrimaries::REC_2020 },
		          expected_sha1[2]);
	}
	{
		SCOPED_TRACE("b67 ictcp->linear rgb");
		test_case_ge({ MatrixCoefficients::REC_2100_ICTCP, TransferCharacteristics::ARIB_B67, ColorPrimaries::REC_2020 },
		          { MatrixCoefficients::RGB, TransferCharacteristics::LINEAR, ColorPrimaries::REC_2020 },
		          expected_sha1[3]);
	}
}
