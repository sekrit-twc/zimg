...
void test_case_ge(bool fullrange, bool chroma, bool ycgco, const char * const *expected_sha1)
{
	const unsigned w = 640;
	const unsigned h = 480;
...
TEST(DepthConvertTest, test_nop_ge)
{
...
TEST(DepthConvertTest, test_half_to_float_ge)
{
...
TEST(DepthConvertTest, test_float_to_half_ge)
{
	static const char *expected_sha1[] = {
		"8907defd10af0b7c71abfb9c20147adc1b0a1f70",
...
TEST(DepthConvertTest, test_limited_luma_ge)
{
	static const char *expected_sha1[] = {
		{ "a7096d8251091eb2188bb2bec9fee9d0495faf2c" },
		{ "705050fb0e56681004ede72126bd264d6c4268d9" },
	...
	test_case_ge(false, false, false, expected_sha1);
	test_case_ge(false, false, true, expected_sha1);
}
...
TEST(DepthConvertTest, test_limited_chroma_ge)
{
	static const char *expected_sha1[] = {
		{ "7c84d9bc8a271e543d8e6a503ffdeb651d9b60d9" },
		{ "f0ab1d4b4fa8a87006137918c5bfb423a1020079" },
	...
	test_case_ge(false, true, false, expected_sha1);
}
...
TEST(DepthConvertTest, test_limited_chroma_ycgco_ge)
{
	static const char *expected_sha1[] = {
		{ "3eafedbfa0fcd9d99ad374db94d38f632015123e" },
		{ "7f7f511df52314e078bc9b059fb7c6ae83926b7f" },
	...
	test_case_ge(false, true, true, expected_sha1);
}
...
TEST(DepthConvertTest, test_full_luma_ge)
{
	static const char *expected_sha1[] = {
		{ "f0e4a68158eab0ab350c7161498a8eed3196c233" },
		{ "20c77820ff7d4443a0de7991218e2f8eee551e8d" },
	...
	test_case_ge(true, false, false, expected_sha1);
	test_case_ge(true, false, true, expected_sha1);
}
...
TEST(DepthConvertTest, test_full_chroma_ge)
{
	static const char *expected_sha1[] = {
		{ "333be81b7364a126a2a6167522b539cfad599814" },
		{ "48a95801578c440f7180c799bdc344a873c6d8d6" },
	...
	test_case_ge(true, true, false, expected_sha1);
	test_case_ge(true, true, true, expected_sha1);
}
...
TEST(DepthConvertTest, test_padding_bits_ge)
{
	const unsigned w = 640;
	const unsigned h = 480;
