...
void test_case(const zimg::PixelFormat &pixel_in, const zimg::PixelFormat &pixel_out, const char *expected_sha1, double expected_snr)
{
	...
	auto result_sse2 = zimg::depth::create_dither_ge(dither, w, h, pixel_in, pixel_out, planes, zimg::CPUClass::X86_SSE2);
...
TEST(DitherSSE2Test, test_ordered_dither_f2w)
{
	...
	const char *expected_sha1 = "5312234ac7d6198f138b2cded18b5bf48b6af568";
