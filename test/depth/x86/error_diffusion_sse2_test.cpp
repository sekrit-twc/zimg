...
void test_case_ge(const zimg::PixelFormat &pixel_in, const zimg::PixelFormat &pixel_out, const char *expected_sha1, double expected_snr)
{
	...
	zimg::depth::DepthConversion::result result_sse2 = zimg::depth::create_dither_ge(dither, w, h, pixel_in, pixel_out, planes, zimg::CPUClass::X86_SSE2);
	ASSERT_TRUE(result_c.filter_refs[0]);
	ASSERT_TRUE(result_sse2.filter_refs[0]);
	ASSERT_FALSE(assert_different_dynamic_type(result_c.filter_refs[0], result_sse2.filter_refs[0]));

	graphengine::FilterValidation(result_sse2.filter_refs[0], { w, h, zimg::pixel_size(pixel_in.type) })
...
TEST(ErrorDiffusionSSE2Test, test_error_diffusion_b2b_ge)
{
	zimg::PixelFormat pixel_in{ zimg::PixelType::BYTE, 8, true, false };
	zimg::PixelFormat pixel_out{ zimg::PixelType::BYTE, 1, true, false };
...
TEST(ErrorDiffusionSSE2Test, test_error_diffusion_b2w_ge)
{
	zimg::PixelFormat pixel_in{ zimg::PixelType::BYTE, 8, true, false };
	zimg::PixelFormat pixel_out{ zimg::PixelType::WORD, 9, true, false };
...
TEST(ErrorDiffusionSSE2Test, test_error_diffusion_w2b_ge)
{
	zimg::PixelFormat pixel_in = zimg::PixelType::WORD;
	zimg::PixelFormat pixel_out = zimg::PixelType::BYTE;
...
TEST(ErrorDiffusionSSE2Test, test_error_diffusion_w2w_ge)
{
	zimg::PixelFormat pixel_in{ zimg::PixelType::WORD, 16, false, false };
	zimg::PixelFormat pixel_out{ zimg::PixelType::WORD, 10, false, false };
...
TEST(ErrorDiffusionSSE2Test, test_error_diffusion_h2b_ge)
{
	zimg::PixelFormat pixel_in = zimg::PixelType::HALF;
	zimg::PixelFormat pixel_out = zimg::PixelType::BYTE;
...
TEST(ErrorDiffusionSSE2Test, test_error_diffusion_h2w_ge)
{
	zimg::PixelFormat pixel_in = zimg::PixelType::HALF;
	zimg::PixelFormat pixel_out = zimg::PixelType::WORD;
...
TEST(ErrorDiffusionSSE2Test, test_error_diffusion_f2b_ge)
{
	zimg::PixelFormat pixel_in = zimg::PixelType::FLOAT;
	zimg::PixelFormat pixel_out = zimg::PixelType::BYTE;

	const char *expected_sha1 = "c739ba4bed041192bc6167e03975fc5a709561b4";
...
TEST(ErrorDiffusionSSE2Test, test_error_diffusion_f2w_ge)
{
	zimg::PixelFormat pixel_in = zimg::PixelType::FLOAT;
	zimg::PixelFormat pixel_out = zimg::PixelType::WORD;

	const char *expected_sha1 = "834f918f24da72a31bb6deb7b1e398446cf052a2";
