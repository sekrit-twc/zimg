...
void test_case_ge(zimg::depth::DitherType type, bool fullrange, bool chroma, const char * const *expected_sha1)
{
	const unsigned w = 640;
	const unsigned h = 480;
...
TEST(DitherTest, test_limited_luma_ge)
{
	...
	test_case_ge(zimg::depth::DitherType::NONE, false, false, expected_sha1);
}
...
TEST(DitherTest, test_limited_chroma_ge)
{
	static const char *expected_sha1[] = {
		"02c0adca6d301444ac4bf717fa691fe2758752a5",
		"d5794ead078fee72fd10fc396aef511c96f8279c",
	...
	test_case_ge(zimg::depth::DitherType::NONE, false, true, expected_sha1);
}
...
TEST(DitherTest, test_full_luma_ge)
{
	static const char *expected_sha1[] = {
		"02c0adca6d301444ac4bf717fa691fe2758752a5",
		"e9587ac91d9b275d2d0cd5fbf86d603d676b2b42",
	...
	test_case_ge(zimg::depth::DitherType::NONE, true, false, expected_sha1);
}
...
TEST(DitherTest, test_full_chroma_ge)
{
	static const char *expected_sha1[] = {
		"02c0adca6d301444ac4bf717fa691fe2758752a5",
		"5e1ed7da45389f9001c0944c9cd26d050ff28cda",
	...
	test_case_ge(zimg::depth::DitherType::NONE, true, true, expected_sha1);
}
...
TEST(DitherTest, test_bayer_dither_ge)
{
	static const char *expected_sha1[] = {
		"02c0adca6d301444ac4bf717fa691fe2758752a5",
		"d5794ead078fee72fd10fc396aef511c96f8279c",
	...
	test_case_ge(zimg::depth::DitherType::ORDERED, false, false, expected_sha1);
}
...
TEST(DitherTest, test_random_dither_ge)
{
	static const char *expected_sha1[] = {
		"02c0adca6d301444ac4bf717fa691fe2758752a5",
		"d5794ead078fee72fd10fc396aef511c96f8279c",
	...
	test_case_ge(zimg::depth::DitherType::RANDOM, false, false, expected_sha1);
}
...
TEST(DitherTest, test_error_diffusion_ge)
{
	static const char *expected_sha1[] = {
		"02c0adca6d301444ac4bf717fa691fe2758752a5",
		"d5794ead078fee72fd10fc396aef511c96f8279c",
	...
	test_case_ge(zimg::depth::DitherType::ERROR_DIFFUSION, false, false, expected_sha1);
}
