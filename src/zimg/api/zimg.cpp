...
constexpr unsigned VERSION_INFO[] = { 2, 9, 254 };
...
zimg::CPUClass translate_cpu(zimg_cpu_type_e cpu)
{
	...
	static SM_CONSTEXPR_14 const zimg::static_map<zimg_cpu_type_e, CPUClass, 19> map{
		...
		{ ZIMG_CPU_ARM_NEON_v8_1, CPUClass::ARM_NEON },
		{ ZIMG_CPU_ARM_NEON_v8_2, CPUClass::ARM_NEON },
		{ ZIMG_CPU_ARM_NEON_v8_3, CPUClass::ARM_NEON },
		{ ZIMG_CPU_ARM_NEON_v8_4, CPUClass::ARM_NEON },
		{ ZIMG_CPU_ARM_NEON_v8_5, CPUClass::ARM_NEON },
		{ ZIMG_CPU_ARM_NEON_v8_6, CPUClass::ARM_NEON },
#endif
	};
