...
const zimg::static_string_map<CPUClass, 6> g_cpu_table{
	{ "none", CPUClass::NONE },
...
const zimg::static_string_map<TransferCharacteristics, 14> g_transfer_table{
	...
	{ "1361",     TransferCharacteristics::REC_1361 },
