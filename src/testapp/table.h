...
extern const zimg::static_string_map<zimg::CPUClass, 4> g_cpu_table;
...
extern const zimg::static_string_map<zimg::colorspace::TransferCharacteristics, 3> g_transfer_table;
