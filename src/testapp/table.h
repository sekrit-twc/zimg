...
extern const zimg::static_string_map<zimg::CPUClass, 6> g_cpu_table;
...
extern const zimg::static_string_map<zimg::colorspace::TransferCharacteristics, 14> g_transfer_table;
